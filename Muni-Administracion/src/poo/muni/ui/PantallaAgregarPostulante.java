...
public class PantallaAgregarPostulante extends javax.swing.JFrame {
    ...
    private ArrayList<Perfil> listaPerfil = new ArrayList<>();
    /**
    ...
    public void cargarComboPerfil(){
        listaPerfil = gestor.getPerfil();
        
        comboPerfil.removeAllItems();
        
        for(Perfil item : listaPerfil){
            comboPerfil.addItem(item.getNombre());
        }
    }
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(comboPerfil, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(0, 0, Short.MAX_VALUE)))
                                .addGap(18, 18, 18)
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        Object itemPrograma = comboPrograma.getSelectedItem();
        Object itemPerfil = comboPerfil.getSelectedItem();
        NivelEducativo nivelEdu = new NivelEducativo();
        Programa programa = new Programa();
        Perfil perfil = new Perfil();
        
        
        for(Perfil per : listaPerfil){
            if(per.getNombre() == itemPerfil){
                perfil = per;
            }
        ...
        if (gestor.guardarPostulante(nivelEdu, perfil, movilidad, dispHoraria, docAdicional, programa, dni, sexo, edad, nombre, cuil, domicilio, telPrincipal, telAlternativo, email, apellido)) {
